<template>
  <v-card
    ...
    :title="`Form ${id ? 'edit' : 'tambah'} data jadwal kerja`"
    ...
    <v-form ref="formRef" @submit.prevent="handleConfirm">
      <v-card-text>
        <v-row dense>
          ...
          <v-col md="4" :cols="12">
            <v-date-input
              v-model="formData.work_day_start"
          ...
          <v-col md="4" :cols="12">
            <v-date-input
              v-model="formData.work_day_finish"
