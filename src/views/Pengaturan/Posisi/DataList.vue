...
import { usePosisi } from './usePosisi'
        ...
        <template #[`item.actions`]="{ item }">
          <div class="d-flex ga-2 justify-end">
            <v-icon
              ...
              v-if="permissionCheck('view_job::position')"
            />
            <v-icon
              color="medium-emphasis"
              icon="mdi-pencil"
              ...
              v-if="permissionCheck('update_job::position')"
            />
            <v-icon
              color="medium-emphasis"
              icon="mdi-delete"
              ...
              v-if="permissionCheck('delete_job::position')"
            />
          </div>
        </template>
      </v-data-table-server>
    ...
    <div class="text-center pa-4">
      <v-dialog v-model="formState.dialog.show" :max-width="formState.dialog.maxwidth" persistent>
        ...
        <FormSubmit
          ...
          :title="formState.isEdit ? 'Edit Posisi' : 'Tambah Posisi'"
          :cancelText="'Batal'"
