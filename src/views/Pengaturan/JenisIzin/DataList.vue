...
import { useJenisIzin } from './useJenisIzin'
        ...
        <template #[`item.actions`]="{ item }">
          <div class="d-flex ga-2 justify-end">
            <v-icon
              ...
              v-if="permissionCheck('view_permit::type')"
            />
            <v-icon
              color="medium-emphasis"
              icon="mdi-pencil"
              ...
              v-if="permissionCheck('update_permit::type')"
            />
            <v-icon
              color="medium-emphasis"
              icon="mdi-delete"
              ...
              v-if="permissionCheck('delete_permit::type')"
            />
          </div>
        </template>
      </v-data-table-server>
    ...
    <div class="text-center pa-4">
      <v-dialog v-model="formState.dialog.show" :max-width="formState.dialog.maxwidth" persistent>
        ...
        <FormSubmit
          ...
          :title="formState.isEdit ? 'Edit Jenis Izin' : 'Tambah Jenis Izin'"
          :cancelText="'Batal'"
        ...
        <DataShow
          ...
          icon="mdi-information"
          :data="formState.formData"
          title="Informasi data jenis izin"
          text="Berikut adalah detail data jenis izin yang anda pilih."
          cancelText="Tutup"
          @cancel="handleCancelForm"
