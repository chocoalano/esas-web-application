...
import { useDepartemen } from './useDepartement'
        ...
        <template #[`item.actions`]="{ item }">
          <div class="d-flex ga-2 justify-end">
            <v-icon
              ...
              v-if="permissionCheck('view_departement')"
            />
            <v-icon
              color="medium-emphasis"
              icon="mdi-pencil"
              ...
              v-if="permissionCheck('update_departement')"
            />
            <v-icon
              color="medium-emphasis"
              icon="mdi-delete"
              ...
              v-if="permissionCheck('delete_departement')"
            />
          </div>
        </template>
      </v-data-table-server>
    ...
    <div class="text-center pa-4">
      <v-dialog v-model="formState.dialog.show" :max-width="formState.dialog.maxwidth" persistent>
        ...
        <FormSubmit
          ...
          :title="formState.isEdit ? 'Edit Departemen' : 'Tambah Departemen'"
          :cancelText="'Batal'"
          :confirmText="formState.isEdit ? 'Perbarui' : 'Simpan'"
          :selectItem="formState.selectItem"
        ...
        <DataShow
          ...
          icon="mdi-information"
          :data="datashow"
          title="Informasi data departemen"
          text="Berikut adalah detail data departemen yang anda pilih."
          cancelText="Tutup"
          @cancel="handleCancelForm"
