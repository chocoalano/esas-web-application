  ...
  >
          ...
          <tr>
            <td colspan="3">
              <v-select
                ...
                :items="formState.selectItemCompany"
                item-title="name"
                item-value="id"
                class="mt-6 ml-2"
                density="compact"
            ...
            <td>
              <v-select
                ...
                :items="formState.selectItemDepartement"
                item-title="name"
                item-value="id"
                class="mt-6 ml-2"
                density="compact"
                variant="outlined"
                @update:modelValue="onDepartemenChange(filters.company, filters.departemen)"
              ></v-select>
            </td>
            <td>
              <v-select
                v-model="filters.position"
                :items="formState.selectItemPosition"
                item-title="name"
                item-value="id"
                class="mt-6 ml-2"
                density="compact"
                variant="outlined"
                @update:modelValue="onPositionChange(filters.company, filters.departemen)"
              ></v-select>
            </td>
            <td>
              <v-select
                v-model="filters.level"
                :items="formState.selectItemLevel"
                item-title="name"
                item-value="id"
                class="mt-6 ml-2"
                density="compact"
    ...
    <div class="text-center pa-4">
      <v-dialog v-model="formState.dialog.show" :max-width="formState.dialog.maxwidth" persistent>
        ...
        <CardDialogConfirmation
          v-if="formState.dialog.variant === 'confirmation-reset'"
          icon="mdi-alert"
        ...
        <CardDialogConfirmation
          v-if="formState.dialog.variant === 'confirmation-reset-password'"
          icon="mdi-alert"
        ...
        <FormSubmit
          ...
          :title="formState.isEdit ? 'Edit Pengguna' : 'Tambah Pengguna'"
          :cancelText="'Batal'"
          ...
          :selectItemPosition="formState.selectItemPosition"
          :selectItemLevel="formState.selectItemLevel"
          :selectItemLine="formState.selectItemLine"
          :selectItemMngr="formState.selectItemMngr"
        ...
        <DataShow
          ...
          text="Berikut adalah detail data pengguna yang anda pilih."
          cancelText="Tutup"
          @cancel="handleCancelForm"
