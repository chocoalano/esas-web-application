        ...
        <v-row dense>
          <v-col md="6" cols="12">
            <v-sheet border rounded class="py-5 px-5">
              <v-row dense>
                <v-col md="6" cols="12">
                  <v-autocomplete v-model="formData.company_id" :items="selectOptions.companies" item-title="name"
                    item-value="id" label="Nama Perusahaan" placeholder="Masukkan nama perusahaan" variant="outlined"
                    density="compact" :rules="[rules.required]" required readonly />
                </v-col>
                <v-col md="6" cols="12">
                  <v-text-field v-model="formData.nip" label="NIP" placeholder="input NIP disini" type="number"
                    variant="outlined" density="compact" :rules="[rules.required]" readonly></v-text-field>
                </v-col>
                <v-col md="6" cols="12">
                ...
                <v-col md="6" cols="12">
                  <v-text-field v-model="formData.password" label="Password" placeholder="input password disini"
                    type="password" variant="outlined" density="compact" :rules="[rules.required]"></v-text-field>
                </v-col>
                <v-col md="6" cols="12">
              ...
              <v-row dense>
                <v-col md="6" cols="12">
                  <v-text-field v-model="formData.details.phone" label="HP/Telp" placeholder="input HP/Telp disini"
                    type="number" variant="outlined" density="compact" :rules="[rules.required]"></v-text-field>
                </v-col>
                <v-col md="6" cols="12">
                ...
                <v-col md="6" cols="12">
                  <v-date-input v-model="formData.details.datebirth" label="Tempat lahir"
                    ...
                    prepend-inner-icon="$calendar" :rules="[rules.required]"></v-date-input>
                </v-col>
                <v-col md="6" cols="12">
              ...
              <v-row dense>
                ...
                <v-col md="3" cols="12">
                  <v-text-field v-model="formData.address.province" label="Provinsi" placeholder="input provinsi disini"
                    type="text" variant="outlined" density="compact" :rules="[rules.required]"></v-text-field>
                </v-col>
                <v-col md="3" cols="12">
                  <v-text-field v-model="formData.address.city" label="Kota" placeholder="input kota disini" type="text"
                    variant="outlined" density="compact" :rules="[rules.required]"></v-text-field>
                </v-col>
                <v-col md="6" cols="12">
                  <v-textarea v-model="formData.address.citizen_address" label="Alamat tinggal identitas"
                    row-height="20" rows="2" auto-grow variant="outlined" :rules="[rules.required]"></v-textarea>
                </v-col>
                <v-col md="6" cols="12">
