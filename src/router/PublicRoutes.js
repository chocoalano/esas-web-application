  ...
  children: [
    {
      name: 'Login',
      path: 'login',
      component: () => import('@/views/Public/Unauth/LoginView.vue'),
    },
    {
      path: '',
      redirect: '/login',
    },
    {
      path: '/:catchAll(.*)',
      name: 'NotFound',
      component: () => import('@/views/Public/Unauth/NotFound.vue'),
    },
  ],
};
...
const PublicAuthRoutes = {
  ...
  children: [
    ...
    {
      path: 'general/dokumentasi/:id',
      name: 'dokumentasi',
      component: () => import('@/views/Public/Auth/DokumentasiView.vue'),
    },
    {
      path: 'general/pemberitahuan',
      name: 'pemberitahuan',
      component: () => import('@/views/Public/Auth/PemberitahuanView.vue'),
    },
    {
      path: 'general/profil',
      name: 'profil',
      component: () => import('@/views/Public/Auth/ProfileView.vue'),
    },
  ],
};

// Export sebagai array
export default [PublicUnauthRoutes, PublicAuthRoutes];
